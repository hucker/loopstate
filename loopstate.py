...
class LoopState2:
    ...
    first: bool = False  # First item in seq
    last: bool = False  # Last item in seq
    only: bool = False  # Only item in seq
    index: int = -1  # Index of item in seq



def loop_state2(values: Iterable[T]) -> Iterable[Tuple[T, LoopState]]:
    """
    Iterate and generate state data related to a sequence.
